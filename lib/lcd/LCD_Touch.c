...
bool TP_GetCoords(uint16_t* x, uint16_t* y){
    bool pressed = false;
    spi_set_baudrate(SPI_PORT, TP_SPI_BAUDRATE);
    pressed = TP_PRESS_DOWN & TP_Scan(0);
    spi_set_baudrate(SPI_PORT, LCD_SPI_BAUDRATE);
